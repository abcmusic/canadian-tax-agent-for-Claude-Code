...
name: seo-schema
description: Use to detect, validate, and generate structured data markup. Prefers JSON-LD, validates required properties, flags deprecated types (HowTo, SpecialAnnouncement, ClaimReview, etc.), restricts FAQ to gov/health, and tracks current rich-result eligibility as of February 2026.
---
...
- **Practice Problem**: listed deprecated late-2025 in some sources but unverified — re-verify at audit time before flagging
- **Book Actions**: Deprecated then reversed — still functional as of Feb 2026 (historical note)

### ACTIVE — do not flag as deprecated:
- **Dataset**: present in Google's current rich-results gallery. Listed deprecated late-2025 in some sources but confirmed supported as of 2026-08; treat as supported, re-verify at audit time.
- **Discussion forum** (`DiscussionForumPosting`): active rich result for forum/community/UGC threads.
