...
| Practice Problem | Claimed retired in some sources | Late 2025 | **Unverified deprecation** — listed deprecated late-2025 in some sources; re-verify at audit time before flagging |

> **Dataset — NOT deprecated:** present in Google's current rich-results gallery as of 2026-08. Listed deprecated late-2025 in some sources but confirmed supported; treat as an Active/supported type below, and re-verify at audit time.

> **Discussion forum** rich result (`DiscussionForumPosting`, listed under Active above) is a currently supported type for UGC/forum threads — not deprecated.
