...
## Ranking Update History — check live, do not trust hardcoded dates

Do not rely on a hardcoded "latest update" claim in this file. At audit time, fetch **status.search.google.com/summary** for the current list of ranking/spam updates. As of this writing, updates through Jun 2026 are known to exist (Feb 2026 Discover, Mar 2026 core + spam, May 2026 core, Jun 2026 spam) — but that list itself may be stale by the time you read this; the live status page is the source of truth.

> **E-E-A-T applies to competitive queries broadly, not just YMYL** — this has been Google's direction since the Dec 2025 core update.

The December 2025 core update (per practitioner commentary — not an official Google statement):
...
**Uncited third-party estimates — do not present as fact in reports:**
| Industry | Claimed traffic drop |
|----------|--------------|
| Affiliate sites | 71% average decline |
| Health/YMYL | 67% average decline |
| E-commerce | 52% average decline |

These industry figures and the "watershed moment" framing are uncited third-party claims, not Google-documented facts. Label them as such if cited in a report.
...
> Google publishes no numeric weights for E-E-A-T components. Its actual documented statement (creating-helpful-content doc): **"trust is the most important member of the E-E-A-T family."** Do not present invented percentage weights as fact.
